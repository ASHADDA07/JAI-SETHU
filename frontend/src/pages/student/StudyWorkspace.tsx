...
import { 
  BookOpen, Clock, Trophy, Check, Search, 
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
           ...
           {/* 2. TODAY'S GOALS (Refactored to shadcn Card) */}
           <Card>
              <CardHeader>
                <CardTitle className="text-sm uppercase tracking-wider text-gray-500">Today's Targets</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            {/* LANDMARK CASES LIBRARY (Refactored to shadcn Card) */}
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                <CardTitle className="text-lg font-serif">Landmark Judgments Library</CardTitle>
                <div className="relative">
                  <input 
                    type="text" 
                    placeholder="Search cases..." 
                    className="pl-8 pr-3 py-1 bg-gray-50 border border-gray-200 rounded text-xs focus:ring-1 focus:ring-[#D4AF37] outline-none"
                  />
