      ...
      <div className="flex h-[calc(100vh-140px)] bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg">
        ...
        <div className="w-80 border-r border-gray-200 bg-gray-50 flex flex-col">
           <div className="p-4 border-b border-gray-200 bg-white">
               <h2 className="text-xl font-serif font-bold text-gray-900 mb-4">Client Messages</h2>
        ...
        {activeChat ? (
                    ...
                    {messages.map((msg, idx) => {
                        ...
                        return (
                            <div key={idx} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                                <div className={`
                                    max-w-[70%] p-3 rounded-2xl text-sm shadow-sm relative
                                    ${isMe 
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-gray-50/50">
                ...
                <p className="text-gray-500 max-w-sm text-center">
                    Select a client from the sidebar to view your message history.
                </p>
            </div>
        )}
